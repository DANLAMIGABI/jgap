...
public class MyChromosome
   ...
   * @since 1.0
   */
  public MyChromosome(final Configuration a_configuration, Gene[] a_initialGenes)
      throws InvalidConfigurationException {
  ...
  public synchronized Object clone() {
    ...
    try {
      if (copy == null) {
        ...
        if (size > 0) {
          ...
          // ---------------------------------------------------------------
          if (getClass() == MyChromosome.class) {
            copy = new MyChromosome(getConfiguration(), copyOfGenes);
          }
          else {
            try {
          ...
          if (getClass() == MyChromosome.class) {
            copy = new MyChromosome(getConfiguration());
          }
          else {
            copy = (IChromosome) getConfiguration().getSampleChromosome().clone();
          }
    ...
    if (m_multiObjective != null) {
      if (getClass() == MyChromosome.class) {
        try {
          ( (MyChromosome) copy).setMultiObjectives( (List) cloneObject(
              m_multiObjective));
        } catch (Exception ex) {
          throw new IllegalStateException(ex.getMessage());
        }
  ...
  protected Object cloneObject(Object a_object)
      throws Exception {
	  if(a_object != null)
		  System.out.println("kkkkkkkkk " );//+ a_object.getClass());
  ...
  public static Object cloneObject(Configuration a_config, Object a_object,
      ...
      throws Exception {
    if (a_object == null) {
    	System.out.println("CloneObject return null");
      return null;
    }
    ...
    if (cloner != null) {
      ...
      // ---------------------------------------------------
    	//System.out.println("############################## PORCO CANE" + a_object.getClass().getName());
      return a_object;
    }
  }
  ...
  public static IChromosome randomInitialChromosome(
    ...
    if (pool != null) {
    	System.out.println("MyChromosome.randomInitialChromosome: pool is NOT null");
      ...
      if (randomChromosome != null) {
    	...
    	System.out.println("MyChromosome.randomInitialChromosome: pool is null");
    }
    ...
    for (int i = 0; i < newGenes.length; i++) {
      ...
      if(appData != null) {
//    	  System.out.println("Classe: " + appData.getClass().getName());
        try {
